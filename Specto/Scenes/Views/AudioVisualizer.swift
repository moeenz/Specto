            ...
            ZStack{
                ...
                ForEach(0 ..< self.amplitudes.count, id: \.self) { number in
                    ...
                    vinylView(center: CGPoint(x: geometry.size.width / 2, y:geometry.size.height / 2),
                              ...
                              insideRadius: geometry.size.width / 4,
                ...
                Image("center").rotationEffect(recording ? Angle(radians: +2 * .pi) : Angle(radians: 0))
                    .animation(animation)
...
struct vinylView: View {
    ...
    var body: some View {
        ...
        ForEach(0 ..< self.amplitudes.count) { counter in
            ...
            .fill(Color(UIColor(white: 1 - CGFloat(amplitudes[counter]), alpha: 0.7 )))
